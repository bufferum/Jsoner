...
public class Test_jsoner_read {
    ...
    @Test public void value() {
        ...
        System.out.print("Update-value:" + String.valueOf(result));
    ...
    @Test public void value_inner_array() {
        ...
        System.out.print("Update-value_inner_array:" + String.valueOf(result));
    ...
    @Test public void array() {
        ...
        System.out.print("Update-array:" + result);
